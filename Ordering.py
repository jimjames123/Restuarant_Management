...
print('BELOW IS OUR MENU , MAKE YOU PLEASE PLACE ORDER!!!!!')
print("🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃🥃")
...
# Here we have created instances and write the code to run the program since 
# we have the required classes and methods.


food1 = Food('Chips and chicken', 25000, 30)
food2 = Food('Chicken and rice', 16000, 40)
food3 = Food('Sausage and plantain', 1000, 80)
food4 = Food('Chaps and chips', 14000, 100)
food5 = Food('fish and posho', 20000, 280)
food6 = Food('Sandwich', 8000, 180)
food7 = Food('Burger', 12000, 240)
food8 = Food('Streetwise', 24000, 100)
food9 = Food('Rice and liver', 3000, 170)
food10 = Food('Pilau and beef', 15000, 140)
...
# This Takes the input from the console and assigns it to the count variable
count=int(input('How many meals would you like to purchase? (10% off for 3 or more): '))

# This calls the get_total_price method from selected_food and from selected_drink
result=selected_food.get_total_price(count)+selected_drink.get_total_price(count)

# Our Output 
print('Your total is UGX ' +str(result))
print('Thank you for you for your support Hope to see you again.')
# print('**********************PLEASE DRIVE THROUGH******************')
